...
class AgenticGrantProposalWriterSession(Base):
    __tablename__ = "grant_proposal_writer_sessions"
...
class AgenticGrantProposalWriterItem(Base):
    __tablename__ = "grant_proposal_writer_items"

    id = Column(String, primary_key=True, index=True)
    session_id = Column(String, ForeignKey("grant_proposal_writer_sessions.id"))
